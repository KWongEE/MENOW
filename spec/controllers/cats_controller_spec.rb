...
RSpec.describe CatsController, type: :controller do
  ...
  describe "POST#create" do
   before(:each) do
      ...
      sign_in(@user)
      @cat = Cat.create(name: "Joshua", description: "Long maned cat", location: "77 Street", user: @user)
    end
    ...
    it "should create a new cat" do
      ...
      post :create, params: {cat: {name:"Joshua",description:"Long maned cat",location:"77 Street", user: @user}}, format: :json
binding.pry
